...
class create:
  ...
  # def zaxis(self, targetId):
  #     zaxis = [0]*8  # Initiates z-axis list with a single element, initially 0.

  #     # Position & orientation of self object
  #     selfPositionAndOrientation = p.getBasePositionAndOrientation(self.bodyId)
  #     selfPosition = np.array(selfPositionAndOrientation[0])

  #     zaxis[0] = selfPosition[2]  # Store the z-axis position of the self object
