...
CONFIG = neat.config.Config(neat.genome.DefaultGenome, neat.reproduction.DefaultReproduction,
                            ...
                            'pureples/pureples/experiments/mountain_car/config_cppn_mountain_car')
...
if __name__ == '__main__':
    ...
    draw_net(cppn, filename="pureples/pureples/experiments/mountain_car/hyperneat_mountain_car_cppn")
    draw_net(NET, filename="pureples/pureples/experiments/mountain_car/hyperneat_mountain_car_winner")
    with open('pureples/pureples/experiments/mountain_car/hyperneat_mountain_car_cppn.pkl', 'wb') as output:
