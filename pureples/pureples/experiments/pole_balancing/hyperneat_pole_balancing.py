...
CONFIG = neat.config.Config(neat.genome.DefaultGenome, neat.reproduction.DefaultReproduction,
                            ...
                            'pureples/pureples/experiments/pole_balancing/config_cppn_pole_balancing')
...
if __name__ == '__main__':
    ...
    draw_net(
        CPPN, filename="pureples/pureples/experiments/pole_balancing/hyperneat_pole_balancing_cppn")
    with open('pureples/pureples/experiments/pole_balancing/hyperneat_pole_balancing_cppn.pkl', 'wb') as output:
        pickle.dump(CPPN, output, pickle.HIGHEST_PROTOCOL)
    draw_net(
        WINNER_NET, filename="pureples/pureples/experiments/pole_balancing/hyperneat_pole_balancing_winner")
