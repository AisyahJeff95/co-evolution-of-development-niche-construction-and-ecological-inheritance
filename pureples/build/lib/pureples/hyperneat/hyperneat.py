...
def query_cppn(coord1, coord2, outgoing, cppn, max_weight=5.0):
    ...
    if outgoing:
        i = [*[coor for coor in coord1], *[coor for coor in coord2], 1.0, *(len(cppn.input_nodes)-7)*[0]]
    else:
        i = [*[coor for coor in coord2], *[coor for coor in coord1], 1.0, *(len(cppn.input_nodes)-7)*[0]]
